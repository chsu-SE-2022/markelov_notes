...
namespace лб9_10 {
	...
	private: System::Windows::Forms::DataGridViewTextBoxColumn^ НомерСтроки;
	private: System::Windows::Forms::DataGridViewTextBoxColumn^ dataGridViewTextBoxColumn1;
	private: System::Windows::Forms::DataGridViewTextBoxColumn^ НевернаяЛексема;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->НомерСтроки = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			this->dataGridViewTextBoxColumn1 = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			this->НевернаяЛексема = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			...
			this->richTextBox1->Size = System::Drawing::Size(303, 421);
			...
			this->richTextBox2->Size = System::Drawing::Size(303, 421);
			...
			this->dataGridView1->Location = System::Drawing::Point(12, 480);
			...
			this->dataGridView2->Location = System::Drawing::Point(288, 480);
			...
			this->dataGridView3->Location = System::Drawing::Point(564, 480);
			...
			this->dataGridView4->Location = System::Drawing::Point(840, 480);
			...
			this->dataGridView5->Location = System::Drawing::Point(1116, 480);
			...
			this->button4->Location = System::Drawing::Point(1171, 422);
			...
			// richTextBox4
			// 
			this->richTextBox4->Location = System::Drawing::Point(660, 257);
			this->richTextBox4->Name = L"richTextBox4";
			this->richTextBox4->ReadOnly = true;
			this->richTextBox4->Size = System::Drawing::Size(232, 217);
			this->richTextBox4->TabIndex = 19;
			this->richTextBox4->Text = L"";
			// 
			// richTextBox5
			// 
			this->richTextBox5->Location = System::Drawing::Point(909, 257);
			this->richTextBox5->Name = L"richTextBox5";
			this->richTextBox5->ReadOnly = true;
			this->richTextBox5->Size = System::Drawing::Size(230, 217);
			...
			this->label4->Location = System::Drawing::Point(724, 231);
			...
			this->label5->Location = System::Drawing::Point(929, 231);
			...
			this->dataGridView6->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(3) {
				this->НомерСтроки,
					this->dataGridViewTextBoxColumn1, this->НевернаяЛексема
			});
			this->dataGridView6->Location = System::Drawing::Point(660, 12);
			this->dataGridView6->Name = L"dataGridView6";
			this->dataGridView6->Size = System::Drawing::Size(479, 216);
			this->dataGridView6->TabIndex = 23;
			// 
			// НомерСтроки
			// 
			this->НомерСтроки->HeaderText = L"№ строки";
			this->НомерСтроки->Name = L"НомерСтроки";
			this->НомерСтроки->Width = 50;
			// 
			// dataGridViewTextBoxColumn1
			// 
			this->dataGridViewTextBoxColumn1->HeaderText = L"Ошибки";
			...
			// НевернаяЛексема
			// 
			this->НевернаяЛексема->HeaderText = L"Неверная лексема";
			this->НевернаяЛексема->Name = L"НевернаяЛексема";
			// 
			// MyForm
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(1396, 724);
		...
		void Automat2(char c, int& s, string& str, int& i, bool& f, bool& err) {
			switch (s) {
			case 0: {
				switch (c) {
					//пробел, перенос
		...
		public: int err = 0, s1 = 0, count_r = 0, count_z = 0, count_const = 0, count_key = 0, count_id = 0, count_str = 1;
...
#pragma endregion
	...
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		for (int i = 0; i < str00.length(); i++) {
			...
			if (s >= 2 && s <= 9) { //знаки
				...
				if (f && err) {
					symbol = "Неверный знак операции";
					cli::array<String^>^ row = gcnew cli::array<String^> { Convert::ToString(count_str), symbol, marshal_as<String^>(str) };
					dataGridView6->Rows->Add(row);
					symbol = "";
					str = "";
					f = false;
			...
			if (s == 10 || s == 11 || s == 13) { //константы
				if (f && !err) {
					for (int i = 0; i < str.length(); i++)
						symbol += Char::ToString(str[i]);
					if (!search(dataGridView3, symbol)) {
						count_const++;
			...
			if (s == 17) { //ключевые слова
				...
				if (f && err) {
					symbol = "Неверное ключевое слово";
					cli::array<String^>^ row = gcnew cli::array<String^> { Convert::ToString(count_str), symbol, marshal_as<String^>(str) };
					dataGridView6->Rows->Add(row);
					symbol = "";
					str = "";
			...
			if (s == 999) { //идентификаторы
				...
				if (f && err) {
					if (str.length() == 1) symbol = "Неверный символ";
					else symbol = "Неверный идентификатор";
					cli::array<String^>^ row = gcnew cli::array<String^> { Convert::ToString(count_str), symbol, marshal_as<String^>(str) };
					dataGridView6->Rows->Add(row);
					symbol = "";
					str = "";
	...
	private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		prog = "";
		count_r = 0, count_z = 0, count_const = 0, count_key = 0, count_id = 0, count_str = 1;
	}
};
}