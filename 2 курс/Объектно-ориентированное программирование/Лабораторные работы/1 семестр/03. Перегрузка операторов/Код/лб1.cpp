...
void authorization(int& count, int& capacity, int number, int* history, string password, WiFi& Network, Queue& q, Queue& error) {
...
int main() {
    ...
    srand(time(0));
    int number, count = 0, capacity = 100;
    ...
    while (true) {
        ...
        cin.get();
        switch (number) {
        case 1: authorization(count, capacity, number, history, password, Network_1, q, error);
              break;
        case 2: authorization(count, capacity, number, history, password, Network_2, q, error);
              break;
        case 3: authorization(count, capacity, number, history, password, Network_3, q, error);
              break;
        case 4: authorization(count, capacity, number, history, password, Network_4, q, error);
              break;
        case 5: authorization(count, capacity, number, history, password, Network_5, q, error);
              break;
        case 6: authorization(count, capacity, number, history, password, Network_6, q, error);
              break;
        case 7: authorization(count, capacity, number, history, password, Network_7, q, error);
              break;
        case 8: authorization(count, capacity, number, history, password, Network_8, q, error);
              break;
        case 9: authorization(count, capacity, number, history, password, Network_9, q, error);
              break;
        }
    }
    system("pause");
